...
CCCCCCCCCCCC  initial alpha2, gamma calculation over the full observation   CCCCCC
     ...
     &3.0D0*ecy*sin(farr(i)+ompery)*sin(farr(i)))
      ...
      call gam(alpha0rr(i),alpha1rr(i),alpha2rr(i),rl0,Tob,gammaarr(i))
      ntagarr(i)=dble(i)
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
       SUBROUTINE gam(alpha0y,alpha1y,alpha2y,rl0y,t,ans)
       IMPLICIT NONE
...
CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
       ...
       REAL*8 z
       REAL*8 g1,g2
       REAL*8 alpha0x,alpha1x,alpha2x,rl0x
       REAL*8 M,E,f
       REAL*8 Omp,ap,ec,omper,Omo,xxm,Tp
       COMMON /orbit/Omp,ap,ec,omper,Omo,xxm,Tp
       COMMON /alpha/alpha0x,alpha1x,alpha2x,rl0x
     ...
     &alpha0x*z*z*z-alpha1x*z*z-alpha2x*z
